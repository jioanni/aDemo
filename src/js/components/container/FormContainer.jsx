...
class FormContainer extends Component {
  ...
  render() {
    const { name, lastName, address, address2, city, state, zip, dob, ssn, phone, email, outOfWallet, document, response, status } = this.state;
    
    return (
      status ? <Result response = {this.state.status} /> : 
      <div>
